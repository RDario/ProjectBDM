...
<body>
	...
	<br>
	<?php
	$idMedia1 = $_POST['inpIdMedia01'];
	$idMedia2 = $_POST['inpIdMedia02'];
	$idMedia3 = $_POST['inpIdMedia03'];

	$nombreArchivo1 = $_FILES['inpImgNoti01']['name'];
	$nombreArchivo2 = $_FILES['inpImgNoti02']['name'];
	$nombreArchivo3 = $_FILES['inpImgNoti03']['name'];

	if ($nombreArchivo1 != NULL && $nombreArchivo1 != '') {
		$nomTmpArchivo1 = $_FILES['inpImgNoti01']['tmp_name'];
		...
		if (move_uploaded_file($nomTmpArchivo1, "images/$nomAlt1")) {		
...
if ($nombreArchivo2 != NULL && $nombreArchivo2 != '') {
	$nomTmpArchivo2 = $_FILES['inpImgNoti02']['tmp_name'];
	...
	if (move_uploaded_file($nomTmpArchivo2, "images/$nomAlt2")) {
...
if ($nombreArchivo3 != NULL && $nombreArchivo3 != '') {
	$nomTmpArchivo3 = $_FILES['inpImgNoti03']['tmp_name'];
	...
	if (move_uploaded_file($nomTmpArchivo3, "images/$nomAlt3")) {
